...
public class InviteFriendFragment extends MainFragment {
	...
	private void setValues () {
		...
		if ( inviteFriendsAdapter == null ) {
			inviteFriendsAdapter = new InviteFriendsAdapter( vConversationId ,listView, this 
										...
										if (Util.isInternetAvailable()) {	
											...
											if ( vFriendSearchUrl != null && vFriendSearchUrl.trim().length() > 0 ) {
												...
												if ( searchString != null ) {
													...
													if ( ramdomString != null && runnableList != null && Util.isInternetAvailable() ) {
	...
	private void filterText() {
		...
		if ( inviteFriendsAdapter == null ) {
			inviteFriendsAdapter = new InviteFriendsAdapter( vConversationId ,listView, this ,vMainColor,vMainTitleColor,vSecColor,vSecTitleColor);
			listView.setAdapter( inviteFriendsAdapter);
		}
